...
class User_Profiles extends Plugin {
	...
	public function adminSidebar() {
		...
		$guide = HTML_PATH_ADMIN_ROOT . 'plugin/' . $this->className();
		if ( 'configureight' == $site->adminTheme() ) {
			$html = sprintf(
				'<span class="has-icon-link"><a class="nav-link" href="%s"><span class="fa fa-users"></span>%s</a><a class="nav-link icon-link" href="%s" title="%s"><span class="svg-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M561.91 0C549.44 0 406.51 6.49 320 56.89 233.49 6.49 90.56 0 78.09 0 35.03 0 0 34.34 0 76.55v313.72c0 40.73 32.47 74.3 73.92 76.41 36.78 1.91 128.81 9.5 187.73 38.69 8.19 4.05 17.25 6.29 26.34 6.58v.05h64.02v-.05c9.09-.29 18.15-2.53 26.34-6.58 58.92-29.19 150.95-36.78 187.73-38.69C607.53 464.57 640 431 640 390.27V76.55C640 34.34 604.97 0 561.91 0zM296 438.15c0 11.09-10.96 18.91-21.33 14.96-64.53-24.54-153.96-32.07-198.31-34.38-15.9-.8-28.36-13.3-28.36-28.46V76.55C48 60.81 61.5 48 78.06 48c19.93.1 126.55 7.81 198.53 40.49 11.63 5.28 19.27 16.66 19.28 29.44L296 224v214.15zm296-47.88c0 15.16-12.46 27.66-28.36 28.47-44.35 2.3-133.78 9.83-198.31 34.38-10.37 3.94-21.33-3.87-21.33-14.96V224l.14-106.08c.02-12.78 7.65-24.15 19.28-29.44C435.4 55.81 542.02 48.1 561.94 48 578.5 48 592 60.81 592 76.55v313.72z"></path></svg></span><span class="screen-reader-text">%s</span></a></span>',
				$form,
				$L->get( 'Profiles' ),
				$guide,
				$L->get( 'Profiles Guide' ),
				$L->get( 'Profiles Guide' )
			);
		} else {
			$html = sprintf(
