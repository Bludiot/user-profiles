...
;(function($, window, undefined) {
	...
	// If no jQuery.
	if ( ! $ ) {
		console.info( 'Tabs script needs jQuery enqueued.' );
		return;
	}

	// If tabs script already enqueued.
	if ( $.fn.tabslet ) {
		console.info( 'Tabs script is already enqueued.' );
		return;
	}
	...
	$(document).ready(function () {
		...
		$( 'li.active a' ).attr( 'aria-selected', 'true' );
